...
--
-- Host: 127.0.0.1    Database: catalogoSoftware
-- ------------------------------------------------------
...
CREATE TABLE `EquipoVirtual` (
  ...
  KEY `FK_idCuchilla_EquipoVirtual_idx` (`id_Cuchilla`),
  CONSTRAINT `FK_idCuchilla_EquipoVirtual` FOREIGN KEY (`id_Cuchilla`) REFERENCES `Cuchilla` (`id_Cuchilla`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2020-01-16 22:35:03
